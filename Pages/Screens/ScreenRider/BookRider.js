...
const BookRider = () => {
  ...
  useEffect(() => {
    if (rideDetails && pickupCoords && destinationCoords) {
      ...
      const latDelta =
        Math.abs(pickupCoords.latitude - destinationCoords.latitude) * 1.5;
      const lngDelta =
        Math.abs(pickupCoords.longitude - destinationCoords.longitude) * 1.5;
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity
              style={[
                ...
                { backgroundColor: rideStarted ? "#56b1d6" : "#2ed573" },
              ]}
            ...
            >
              <Text style={styles.startRideText}>
                {rideStarted ? "LOCATION ARRIVED" : "START RIDE"}
              </Text>
            </TouchableOpacity>
          </View>
