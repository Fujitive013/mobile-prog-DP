        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.statsContainer}>
                ...
                <View style={styles.statCard}>
                    ...
                    <Text style={styles.statValue}>₱{todayStats.totalEarnings}</Text>
                    ...
                    <View key={request.id} style={styles.requestCard}>
                        <View style={styles.requestHeader}>
                            <View style={styles.passengerInfo}>
                                <Icon name="person-circle" size={24} color="#3498DB" />
                                <Text style={styles.passengerName}>{request.passengerName}</Text>
                            </View>
                            <Text style={styles.timeRequested}>{request.timeRequested}</Text>
                        </View>
                        <View style={styles.routeInfo}>
                            <View style={styles.locationRow}>
                                <Icon name="location" size={16} color="#e74c3c" />
                        ...
                        <View style={styles.requestFooter}>
                            ...
                            <View style={styles.actionButtons}>
                                ...
                                <TouchableOpacity style={styles.acceptButton} onPress={() => acceptRide(request)}>
